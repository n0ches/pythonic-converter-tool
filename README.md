In this program, There is a tool to convert files among CSV, XML and JSON formats in Python. In addition, the tool must be able to validate your XML file via the corresponding XSD file.
